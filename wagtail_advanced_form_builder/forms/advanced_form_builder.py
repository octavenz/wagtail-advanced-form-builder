...
from wagtail_advanced_form_builder.forms.widgets.side_by_side_radio_select_widget import (
...
class AdvancedFormBuilder(FormBuilder):
    ...
    def create_checkboxes_field(self, field, options):
        ...
        options["initial"] = list(
            map(lambda x: x.get("value", "").strip(), field.default_value)
        )
